...
<header>
    ...
    <h2><?php echo $_SESSION["listeUsers"][$_REQUEST["id"]]["prenom"]; ?> <?php echo $_SESSION["listeUsers"][$_REQUEST["id"]]["nom"]; ?>
        - Mon compte</h2>
</header>
...
<section>
    ...
    <article>
        <div class="fieldset">
            ...
            <div class="field">
                <label>Profil
                    : </label><span><?php echo $_SESSION["listeUsers"][$_REQUEST["id"]]["profil_user"]; ?></span>
            </div>
        </div>
    </article>
    ...
    <article>
        <div class="fieldset">
            ...
            <div class="field">
                <label>N° compte
                    : </label><span><?php echo $_SESSION["listeUsers"][$_REQUEST["id"]]["numero_compte"]; ?></span>
            </div>
            <div class="field">
