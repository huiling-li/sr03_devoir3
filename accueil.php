...
<p><a href="myController.php?action=msglist&userid=<?php echo $_SESSION["connected_user"]["id_user"]; ?>"
      target="_blank">Messagerie</a></p>
<p><a href="vw_moncompte.php?userid=<?php echo $_SESSION["connected_user"]["id_user"]; ?>" target="_blank">effectuer un
        virement</a></p>
